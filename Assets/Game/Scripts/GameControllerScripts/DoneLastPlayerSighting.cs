...
public class DoneLastPlayerSighting : MonoBehaviour
{
	...
	public float musicFadeSpeed = 1f;									// The speed at which the music fades.
    ...
    private Vector3 realPlayerPosition;                                 // Reference to players current position.
	...
	void Update ()
	{
        ...
        realPlayerPosition = GameObject.FindWithTag("Player").transform.position;
	}
    ...
    public GameObject WaypointClosestToPlayer()
    {
        ...
        {
            Vector3 directionToTarget = potentialTarget.transform.position - realPlayerPosition;
